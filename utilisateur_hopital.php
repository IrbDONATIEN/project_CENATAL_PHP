          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <div class="card-header bg-secondary">
                <h3 class="m-0 text-white"><i class="fas fa-user"></i>&nbsp;CENATAL|Hôpital</h3>
              </div>
              <form class="pt-3" action="#" id="login-form" method="post">
                <div id="LoginAlert"></div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="loginHopital" name="loginHopital" placeholder="Votre login">
                </div>
                <div class="form-group">
        ...
        $("#LoginBtn").click(function(e){
          if($("#login-form")[0].checkValidity()){
              ...
              $.ajax({
                  ...
                  method : 'post',
                  data : $("#login-form").serialize()+'&action=login_hopi',
                  success:function(response){
                      if(response ==='login_hopi'){
                          window.location = 'hopital/hopital_sante.php';
                      }
                      else{
